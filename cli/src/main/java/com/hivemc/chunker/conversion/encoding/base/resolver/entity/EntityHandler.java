 ...
 */
public abstract class EntityHandler<R, D, T extends Entity> implements TypeHandler<R, ChunkerVanillaEntityType, D, T> {
    private final ChunkerVanillaEntityType entityType;
     ...
     */
    public EntityHandler(ChunkerVanillaEntityType entityType, Class<T> entityClass, Supplier<T> entityConstructor) {
    ...
    @Override
    public ChunkerVanillaEntityType getKey() {
        return entityType;
    }
