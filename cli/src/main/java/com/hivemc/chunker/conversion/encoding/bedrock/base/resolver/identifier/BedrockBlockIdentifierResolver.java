    ...
    public void registerMappings(Version version) {
        ...
        if (version.isGreaterThanOrEqual(1, 21, 110)) {
            ...
            register(BlockMapping.group(ImmutableMultimap.<String, ChunkerVanillaBlockType>builder()
                            ...
                            .build(),
                    BedrockStateGroups.LIGHTNING_ROD
            ));
            ...
            register(BlockMapping.group(ImmutableMultimap.<String, ChunkerVanillaBlockType>builder()
                            ...
                            .build(),
                    BedrockStateGroups.COPPER_GOLEM
            ));
            ...
            register(BlockMapping.group(ImmutableMultimap.<String, ChunkerVanillaBlockType>builder()
                            ...
                            .build(),
                    BedrockStateGroups.SHELF
            ));

            // Copper Torch (normal/wall)
            register(BlockMapping.of("minecraft:copper_torch", "torch_facing_direction", "top", ChunkerVanillaBlockType.COPPER_TORCH));
            registerDuplicateOutput(BlockMapping.of("minecraft:copper_torch", "torch_facing_direction", "unknown", ChunkerVanillaBlockType.COPPER_TORCH));
