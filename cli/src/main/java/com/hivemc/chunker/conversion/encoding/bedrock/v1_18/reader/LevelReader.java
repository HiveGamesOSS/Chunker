package com.hivemc.chunker.conversion.encoding.bedrock.v1_18.reader;
...
public class LevelReader extends com.hivemc.chunker.conversion.encoding.bedrock.v1_17_30.reader.LevelReader {
    ...
    public @Nullable Object readCustomLevelSetting(@NotNull CompoundTag root, @NotNull String targetName, @NotNull Class<?> type) {
        if (targetName.equals("CavesAndCliffs")) return true; // Always supported
