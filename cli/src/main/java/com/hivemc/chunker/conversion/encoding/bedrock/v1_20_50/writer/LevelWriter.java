package com.hivemc.chunker.conversion.encoding.bedrock.v1_20_50.writer;
...
public class LevelWriter extends com.hivemc.chunker.conversion.encoding.bedrock.v1_20_30.writer.LevelWriter {
    ...
    public void writeCustomLevelSetting(ChunkerLevelSettings chunkerLevelSettings, CompoundTag output, String targetName, Object value) {
        ...
        if (targetName.equals("R21Support")) {
            if ((boolean) value && !converter.shouldAllowNBTCopying()) {
                enableExperiments(output, "updateAnnouncedLive2023");
            }
            // Handled
            return;
        }
