package com.hivemc.chunker.conversion.encoding.bedrock.v1_21_50.reader;
...
public class LevelReader extends com.hivemc.chunker.conversion.encoding.bedrock.v1_21_40.reader.LevelReader {
    ...
    public @Nullable Object readCustomLevelSetting(@NotNull CompoundTag root, @NotNull String targetName, @NotNull Class<?> type) {
        if (targetName.equals("WinterDrop2024")) return true;
