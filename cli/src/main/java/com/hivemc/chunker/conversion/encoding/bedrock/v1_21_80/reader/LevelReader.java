package com.hivemc.chunker.conversion.encoding.bedrock.v1_21_80.reader;
...
public class LevelReader extends com.hivemc.chunker.conversion.encoding.bedrock.v1_21_60.reader.LevelReader {
    ...
    public @Nullable Object readCustomLevelSetting(@NotNull CompoundTag root, @NotNull String targetName, @NotNull Class<?> type) {
        ...
        if (targetName.equals("SummerDrop2025")) {
            ...
            return experiments.getByte("y_2025_drop_2", (byte) 0) == (byte) 1;
        }
