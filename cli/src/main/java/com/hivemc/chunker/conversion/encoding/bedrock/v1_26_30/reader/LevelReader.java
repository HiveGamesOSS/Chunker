package com.hivemc.chunker.conversion.encoding.bedrock.v1_26_30.reader;
...
public class LevelReader extends com.hivemc.chunker.conversion.encoding.bedrock.v1_26_20.reader.LevelReader {
    ...
    public @Nullable Object readCustomLevelSetting(@NotNull CompoundTag root, @NotNull ChunkerLevelSettings chunkerLevelSettings, @NotNull String targetName, @NotNull Class<?> type) {
        if (targetName.equals("SummerDrop2026")) return true; // Supported for this release
