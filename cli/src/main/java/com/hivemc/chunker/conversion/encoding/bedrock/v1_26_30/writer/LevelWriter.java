package com.hivemc.chunker.conversion.encoding.bedrock.v1_26_30.writer;
...
public class LevelWriter extends com.hivemc.chunker.conversion.encoding.bedrock.v1_26_20.writer.LevelWriter {
    ...
    public void writeCustomLevelSetting(ChunkerLevelSettings chunkerLevelSettings, CompoundTag output, String targetName, Object value) {
        if (targetName.equals("SummerDrop2026")) return; // Supported for this release
