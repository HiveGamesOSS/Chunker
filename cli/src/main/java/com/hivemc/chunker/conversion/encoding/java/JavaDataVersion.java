...
public class JavaDataVersion implements Comparable<JavaDataVersion> {
    ...
    public static final JavaDataVersion V1_21_6 = register(4435, new Version(1, 21, 6));
    public static final JavaDataVersion V1_21_7 = register(4438, new Version(1, 21, 7));
    public static final JavaDataVersion V1_21_8 = register(4440, new Version(1, 21, 8));
    public static final JavaDataVersion V1_21_9 = register(4554, new Version(1, 21, 9));
    public static final JavaDataVersion V1_21_10 = register(4556, new Version(1, 21, 10));
    public static final JavaDataVersion V1_21_11 = register(4671, new Version(1, 21, 11));

    // 26
    public static final JavaDataVersion V26_1 = register(4786, new Version(26, 1, 0));
    public static final JavaDataVersion V26_1_1 = register(4788, new Version(26, 1, 1));
    public static final JavaDataVersion V26_1_2 = register(4790, new Version(26, 1, 2));
    public static final JavaDataVersion V26_2 = register(4894, new Version(26, 2, 0));
