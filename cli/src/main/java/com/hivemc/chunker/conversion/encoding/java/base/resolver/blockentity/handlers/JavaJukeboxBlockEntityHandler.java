 ...
 */
public class JavaJukeboxBlockEntityHandler extends BlockEntityHandler<JavaResolvers, CompoundTag, JukeboxBlockEntity> {
    public JavaJukeboxBlockEntityHandler() {
        super("minecraft:jukebox", JukeboxBlockEntity.class, JukeboxBlockEntity::new);
    }
