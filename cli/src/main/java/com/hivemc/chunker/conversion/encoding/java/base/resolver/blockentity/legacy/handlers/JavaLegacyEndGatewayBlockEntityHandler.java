 ...
 */
public class JavaLegacyEndGatewayBlockEntityHandler extends BlockEntityHandler<JavaResolvers, CompoundTag, EndGatewayBlockEntity> {
    public JavaLegacyEndGatewayBlockEntityHandler() {
