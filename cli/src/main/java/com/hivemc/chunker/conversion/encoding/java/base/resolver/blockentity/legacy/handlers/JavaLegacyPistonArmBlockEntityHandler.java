 ...
 */
public class JavaLegacyPistonArmBlockEntityHandler extends BlockEntityHandler<JavaResolvers, CompoundTag, JavaPistonMovingBlockEntity> implements GenerateBeforeWriteBlockEntityHandler<JavaPistonMovingBlockEntity>, DoNotProcessBlockEntityHandler<JavaPistonMovingBlockEntity> {
    private static final Set<ChunkerBlockType> GENERATE_BLOCK_TYPES = Set.of(ChunkerVanillaBlockType.MOVING_PISTON_JAVA);

    public JavaLegacyPistonArmBlockEntityHandler() {
        super("Piston", JavaPistonMovingBlockEntity.class, JavaPistonMovingBlockEntity::new);
    }
