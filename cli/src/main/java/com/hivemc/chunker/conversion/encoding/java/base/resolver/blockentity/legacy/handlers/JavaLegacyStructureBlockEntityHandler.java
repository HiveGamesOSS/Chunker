 ...
 */
public class JavaLegacyStructureBlockEntityHandler extends BlockEntityHandler<JavaResolvers, CompoundTag, StructureBlockEntity> {
    /**
    ...
    public JavaLegacyStructureBlockEntityHandler() {
        super("Structure", StructureBlockEntity.class, StructureBlockEntity::new);
    }
