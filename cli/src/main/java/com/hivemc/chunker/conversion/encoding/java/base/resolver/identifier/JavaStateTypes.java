...
public class JavaStateTypes {
    ...
    public static final TypeMapping<String, NoteBlockInstrument> INSTRUMENT = new TypeMapping.Builder<String, NoteBlockInstrument>()
            ...
            .mapping("trumpet", NoteBlockInstrument.TRUMPET)
            .mapping("trumpet_exposed", NoteBlockInstrument.TRUMPET_EXPOSED)
            .mapping("trumpet_oxidized", NoteBlockInstrument.TRUMPET_OXIDIZED)
            .mapping("trumpet_weathered", NoteBlockInstrument.TRUMPET_WEATHERED)
            .build();
    public static final TypeMapping<String, NoteBlockInstrument> INSTRUMENT_PRE_26_1 = new TypeMapping.Builder<String, NoteBlockInstrument>()
            .mapping("harp", NoteBlockInstrument.HARP)
            .mapping("basedrum", NoteBlockInstrument.BASEDRUM)
            .mapping("snare", NoteBlockInstrument.SNARE)
            .mapping("hat", NoteBlockInstrument.HAT)
            ...
            .mapping("piglin", NoteBlockInstrument.PIGLIN)
            .mapping("custom_head", NoteBlockInstrument.CUSTOM_HEAD)
            .mapping("harp", NoteBlockInstrument.TRUMPET)
            .mapping("harp", NoteBlockInstrument.TRUMPET_EXPOSED)
            .mapping("harp", NoteBlockInstrument.TRUMPET_OXIDIZED)
            .mapping("harp", NoteBlockInstrument.TRUMPET_WEATHERED)
            .build();
