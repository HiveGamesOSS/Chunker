package com.hivemc.chunker.conversion.encoding.java.v1_21_2.reader;
...
public class LevelReader extends com.hivemc.chunker.conversion.encoding.java.v1_21.reader.LevelReader {
    ...
    public @Nullable Object readCustomLevelSetting(@NotNull CompoundTag root, @NotNull String targetName, @NotNull Class<?> type) {
        ...
        if (targetName.equals("WinterDrop2024")) {
            ...
            return dataPacks.contains("Enabled") &&
                    dataPacks.getList("Enabled", StringTag.class).contains("winter_drop");
        }
