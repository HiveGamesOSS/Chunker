package com.hivemc.chunker.conversion.encoding.java.v1_21_6.reader;
...
public class LevelReader extends com.hivemc.chunker.conversion.encoding.java.v1_21_4.reader.LevelReader {
    ...
    public @Nullable Object readCustomLevelSetting(@NotNull CompoundTag root, @NotNull String targetName, @NotNull Class<?> type) {
        if (targetName.equals("SummerDrop2025")) return true; // Supported for this release
