...
/**
 * A handler which connects a single direction.
 */
public interface SingleConnectableBlockPreTransformHandler extends BlockPreTransformHandler {
    /**
    ...
    /**
     * Get the direction to connect.
     *
     * @return the direction.
     */
    Direction getConnectableDirection();
    ...
    default Set<Edge> getRequiredEdges(ChunkerColumn column, int x, int y, int z, ChunkerBlockIdentifier blockIdentifier) {
        ...
        return calculateEdges(x, y, z, getConnectableDirection());
    }
    ...
    default ChunkerBlockIdentifier handle(ChunkerColumn column, Map<Edge, ChunkerColumn> neighbours, int x, int y, int z, ChunkerBlockIdentifier blockIdentifier) {
        Direction direction = getConnectableDirection();
