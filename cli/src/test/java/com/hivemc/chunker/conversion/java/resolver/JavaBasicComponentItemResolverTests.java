...
/**
 * Tests to ensure Java Component Item properties encode / decode symmetrically.
 */
public class JavaBasicComponentItemResolverTests {
    ...
    public static final JavaComponentItemStackResolver RESOLVER = new JavaComponentItemStackResolver(resolvers);
